...
- 지금 상태: **Phase 2 완료** (기초 데이터 + 수강 관리 · 변경이력 · 학생 상세정보)
...
정산 엔진(Phase 3), 품의자료(Phase 4), 배포(Phase 5)는 아직입니다.
Sidebar에 어느 Phase에서 만드는지 표시해 두었습니다.

**지원금 사용액과 잔액은 아직 표시하지 않습니다.** 정산을 실행해야 나오는 값이므로,
없는 숫자를 지어내지 않고 Phase 3에서 연결합니다.
...
- [ ] Phase 3 정산 엔진, Phase 4 품의, Phase 5 배포
